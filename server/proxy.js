...
function detectOutOfStock(html, text) {
  ...
  return OOS.some((kw) => combined.includes(kw));
}
...
app.get('/scrape', async (req, res) => {
  ...
  if (ld) {
    ...
    if (ld.lowPrice !== undefined && current_price === null) current_price = ld.lowPrice;
  ...
  if (!current_price) {
    ...
    if (js.price !== null) current_price = js.price;
